...
public class MainActivity extends AppCompatActivity implements HotelAdapter.IHotelAdapter {
    public static final String HOTEL1 = "HOTEL";
    ...
    private void goAdd() {
        startActivityForResult(new Intent(this, InputAcivity.class), REQUEST_CODE_ADD);
    }
    ...
    public void doEdit(int pos) {
        itemPos = pos;
        Intent intent = new Intent(this, InputAcivity.class);
        intent.putExtra(HOTEL, mList.get(pos));
